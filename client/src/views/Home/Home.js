...
function Home() {
  ...
  const loadTransactions = async () => {
    ...
    const response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/transactions?userId=${user._id}`)
  ...
  return (
    <div>
      <h1 className='home-greetings'>Hello {user.fullName}</h1>
      <h1 className='home-heading'>Welcome to the Expense Tracker</h1>
